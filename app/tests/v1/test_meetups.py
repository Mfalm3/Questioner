...
class TestMeetup(BaseTest):
    ...
    def test_create_meetup(self):
        with self.client as c:
            ...
            login = c.post('/api/v1/login', json=self.login_payload, headers=headers)
            ...
            post_meetup = c.post('/api/v1/meetups', json=self.meetup_payload, headers=header_extra)
    ...
    def test_rsvp(self):
        with self.client as c:
            ...
            rsvp_meetup = c.post('/api/v1/meetups/1/rsvps', json=rsvp_payload, headers=header_extra)
